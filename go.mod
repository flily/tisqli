module github.com/flily/tisqli
...
require (
	...
	github.com/pingcap/tidb v0.0.0-20221020075154-7806b7c151ab
	github.com/pingcap/tidb/parser v0.0.0-20221020075154-7806b7c151ab
)
